<template lang="">
    <div>
        <nav class="bg-white border-gray-200 dark:bg-gray-900 sticky z-30 top-0 w-full">
  <div class="sm:min-w-fit flex flex-wrap items-center justify-between mx-auto p-4">
  ...
  <a href="https://flowbite.com/" class="flex items-center">
      <img src="https://img.icons8.com/?size=512&id=JpGSJXycgAYe&format=png" class="h-10 mr-3" alt="Flowbite Logo" />
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">M-Buku</span>
  </a>
  <div class="flex items-center md:order-2">
      <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full" src="https://sm.ign.com/ign_ap/cover/a/avatar-gen/avatar-generations_hugw.jpg" alt="user photo">
      </button>
      <!-- Dropdown menu -->
